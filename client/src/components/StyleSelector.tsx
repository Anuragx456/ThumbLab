...
const StyleSelector = ({value, onChange, isOpen, setIsOpen} : {
    ...
    isOpen: boolean; setIsOpen: (open: boolean) => void}) => {
        ...
        const styleDescriptions: Record<ThumbnailStyle, string> = {
            ...
            "Minimalist" : "Clean, simple, lots of white",
            "Photorealistic" : "Photo-based, natural looking, realistic",
  ...
  return (
    <div className='relative space-y-3 dark'>
        ...
        rounded-md border px-4 py-3 text-left transition bg-white/8 border-white/10 text-zinc-200 hover:bg-white/12'>
        ...
        {isOpen && (
            <div className='absolute bottom-0 z-50 mt-1 w-full rounded-md border border-white/12 bg-black/20 
